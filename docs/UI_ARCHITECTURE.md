...
- maximum rendering FPS, maximum grid render distance, and close-camera grid fade;
...
Grid render distance and near fade are presentation settings. Defaults are 140 and 10 simulation world units respectively. Reset Visuals restores 60 FPS, the default render distance, and enabled proximity fade without resetting simulation, particles, trails, camera, or locale.
