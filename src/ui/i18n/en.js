...
export const en = Object.freeze({
  ...
  photon: { controls: { title: "Photons", off: "OFF", on: "ON", count: "Count", setup: "Photon Setup", preset: "Preset", advanced: "Advanced launch settings", radius: "Start radius (rₛ)", phi: "Start azimuth φ", impactParameter: "Impact parameter b (rₛ)", radialDirection: "Radial direction", angularDirection: "Propagation sense", inward: "Inward", outward: "Outward", counterclockwise: "Counterclockwise", clockwise: "Clockwise", apply: "Apply launch" }, presets: { weak: "Weak Deflection", strong: "Strong Deflection", nearCritical: "Near Critical", capture: "Capture" } },
  inspector: {
