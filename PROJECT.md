...
Current release: **v0.7.3**. The rendering scale boundary is documented in [docs/RENDERING_ARCHITECTURE.md](docs/RENDERING_ARCHITECTURE.md); it does not alter the v0.7 physics model.
